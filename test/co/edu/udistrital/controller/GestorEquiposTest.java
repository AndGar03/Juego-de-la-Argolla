...
public class GestorEquiposTest {
    ...
    void testAgregarEquipoValido() {
        ...
        assertEquals(1, gestorEquipos.getEquipos().size(), "Debe haber un equipo en la lista");
        assertTrue(gestorEquipos.getEquipos().contains(equipoTest1), "El equipo debe estar en la lista");
    }
    ...
    void testAgregarEquipoNulo() {
        ...
        assertEquals(0, gestorEquipos.getEquipos().size(), "No debe haber equipos en la lista");
    }
    ...
    void testAgregarMismoEquipoDosVeces() {
        ...
        assertEquals(1, gestorEquipos.getEquipos().size(), "Debe haber solo un equipo en la lista");
    }
    ...
    void testAgregarMultiplesEquipos() {
        ...
        // Assert
        assertEquals(2, gestorEquipos.getEquipos().size(), "Debe haber dos equipos en la lista");
        assertTrue(gestorEquipos.getEquipos().contains(equipoTest1), "El primer equipo debe estar en la lista");
        assertTrue(gestorEquipos.getEquipos().contains(equipoTest2), "El segundo equipo debe estar en la lista");
    }
    ...
    void testRemoverEquipoExistente() {
        ...
        assertEquals(1, gestorEquipos.getEquipos().size(), "Debe quedar un equipo en la lista");
        assertFalse(gestorEquipos.getEquipos().contains(equipoTest1), "El primer equipo no debe estar en la lista");
        assertTrue(gestorEquipos.getEquipos().contains(equipoTest2), "El segundo equipo debe seguir en la lista");
    }
    ...
    void testRemoverEquipoInexistente() {
        ...
        assertEquals(1, gestorEquipos.getEquipos().size(), "Debe seguir habiendo un equipo en la lista");
        assertTrue(gestorEquipos.getEquipos().contains(equipoTest1), "El equipo original debe seguir en la lista");
    }
    ...
    void testLimpiarEquipos() {
        ...
        assertTrue(gestorEquipos.getEquipos().isEmpty(), "La lista debe estar vacía");
    }
