...
public class GestorJugadoresTest {
    ...
    void testAgregarJugadorValido() {
        ...
        assertEquals(1, gestorJugadores.getJugadores().size(), "Debe haber un jugador en la lista");
        assertTrue(gestorJugadores.getJugadores().contains(jugadorTest1), "El jugador debe estar en la lista");
    }
    ...
    void testAgregarJugadorNulo() {
        ...
        assertEquals(0, gestorJugadores.getJugadores().size(), "No debe haber jugadores en la lista");
    }
    ...
    void testAgregarMismoJugadorDosVeces() {
        ...
        assertEquals(1, gestorJugadores.getJugadores().size(), "Debe haber solo un jugador en la lista");
    }
    ...
    void testAgregarMultiplesJugadores() {
        ...
        // Assert
        assertEquals(3, gestorJugadores.getJugadores().size(), "Debe haber tres jugadores en la lista");
        assertTrue(gestorJugadores.getJugadores().contains(jugadorTest1), "El primer jugador debe estar en la lista");
        assertTrue(gestorJugadores.getJugadores().contains(jugadorTest2), "El segundo jugador debe estar en la lista");
        assertTrue(gestorJugadores.getJugadores().contains(jugadorTest3), "El tercer jugador debe estar en la lista");
    }
    ...
    void testRemoverJugadorExistente() {
        ...
        assertEquals(1, gestorJugadores.getJugadores().size(), "Debe quedar un jugador en la lista");
        assertFalse(gestorJugadores.getJugadores().contains(jugadorTest1), "El primer jugador no debe estar en la lista");
        assertTrue(gestorJugadores.getJugadores().contains(jugadorTest2), "El segundo jugador debe seguir en la lista");
    }
    ...
    void testRemoverJugadorInexistente() {
        ...
        assertEquals(1, gestorJugadores.getJugadores().size(), "Debe seguir habiendo un jugador en la lista");
        assertTrue(gestorJugadores.getJugadores().contains(jugadorTest1), "El jugador original debe seguir en la lista");
    }
    ...
    void testLimpiarJugadores() {
        ...
        assertTrue(gestorJugadores.getJugadores().isEmpty(), "La lista debe estar vacía");
    }
